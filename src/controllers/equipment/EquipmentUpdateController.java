...
public class EquipmentUpdateController extends HttpServlet {
    ...
    private static final String FAILED = "admin-mng-equipment-update.jsp";
    ...
    private void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (admin.getRole() != 2) {
                throw new Exception("EINS-Attempt to update equipment using non-admin account");
            }
            ...
            EquipmentDTO equipment = equipmentManager
                    .updateEquipment(equipmentId, equipmentName, dateBought, warranty,
