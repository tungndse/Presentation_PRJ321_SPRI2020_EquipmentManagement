    ...
    <div id="header">
        ...
        <div id="menubar">
            <ul id="menu">
                ...
                <li class="selected"><a href="another_page.html">Login</a></li>
            </ul>
        </div>
    </div>
        ...
        <div id="content">
            ...
            <form id="loginForm" action="MainController" method="post">
                <table style="width: 60%;">
                    ...
                    <tr>
                        <td colspan="2">
                            <button form="loginForm" type="submit" name="action" value="Login"
                                    style="width: 100%; height: 30px">Login
                            </button>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="text-align: center"><a href="user-registration.jsp">Sign Up</a></td>
                    </tr>
                    <tr>
                        <td colspan="2"><span style="color: red">
                            <c:out value="${requestScope.LOGIN_FAILURE}"/></span></td>
                    </tr>
                </table>
            </form>
        </div>
