    ...
    <div id="header">
        ...
        <div id="menubar">
            <ul id="menu">
                ...
                <li class="selected"><a href="user-home.jsp">Home</a></li>
...
<%--<h1>Equipment Website</h1>
<hr>
<h1>Welcome user <c:out value="${sessionUser.givenName}"/> <c:out value="${sessionUser.lastName}"/></h1>
<p>Logged in at <fmt:formatDate value="${sessionUser.timeLogin}" pattern="HH:mm EEE, dd/MM/yyyy"/> as <c:out value="${sessionUser.username}"/></p>
<hr>
<c:if test="${notificationCount > 0}">
    <p>You have <c:out value="${notificationCount}"/> notification(s).</p>
</c:if>
<hr>
<a href="user-view-equipment.jsp">View Equipments</a>
<a href="user-view-request.jsp">Your requests</a>
    ...
    <tr>
        ...
        <td>
            ...
            <table>
                ...
                <tr>
                    <td colspan="2">
                        <button form="mainForm" name="action" type="submit" value="DeleteNotification"
                                style="width: 100%;">
                            Remove selected
                        </button>
                    </td>
                ...
                <tr>
                    <td colspan="2">
                        <button form="mainForm" name="action" type="submit" value="DeleteAllNotification"
                                style="width: 100%;">
                            Remove All
                        </button>
                    </td>
