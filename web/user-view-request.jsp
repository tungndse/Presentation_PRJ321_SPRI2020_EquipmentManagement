...
<c:set var="requestList" value="${requestScope.REQUEST_LIST}"/>
    ...
    <div id="header">
        ...
        <div id="menubar">
            <ul id="menu">
                ...
                <li><a href="user-view-equipment.jsp">Equipment</a></li>
                <li class="selected"><a href="user-view-request.jsp">Requests</a></li>
    ...
    <div id="site_content">
        ...
        <c:if test="${not empty requestList}">
            ...
            <table>
                ...
                <c:forEach var="request" items="${requestList}" varStatus="counter">
                    <tr>
                        <td>${counter.count}</td>
                        <td>${request.equipment.id}</td>
                        <td>${request.equipment.name}</td>
                        <td><fmt:formatDate value="${request.timeRequested}" pattern="dd/MM/yyyy"/></td>
                        <td>${request.dateCountSinceRequest}</td>
                        <c:if test="${not empty request.executor}">
                            <td>${request.executor.username}</td>
                            <td><fmt:formatDate value="${request.timeBegin}" pattern="dd/MM/yyyy"/></td>
                            <td>${request.dateCountSinceBegin}</td>
                        </c:if>
                        <c:if test="${empty request.executor}">
                            <td>Not yet</td>
                            <td>Not yet</td>
                            <td>0</td>
                        </c:if>
                        <td>
                            <c:url var="requestDetailsLink" value="MainController">
                            ...
                            <a href="${requestDetailsLink}">More</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
...
<hr>
<a href="user-view-equipment.jsp">Equipment Page</a>
<hr>
<c:if test="${not empty requestList}">
    <table>
        <tr>
        ...
        <c:forEach var="request" items="${requestList}" varStatus="counter">
            <tr>
                ...
                <td>
                    ...
                    <a href="${requestDetailsLink}">Details</a>
                </td>
            </tr>
        </c:forEach>
    </table>
