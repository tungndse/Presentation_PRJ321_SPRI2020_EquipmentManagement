...
<div id="main">
    ...
    <div id="site_content">
        ...
        <strong>You're reading this request as admin</strong>
        <hr>
        <table>
            <tr>
                <th>Equipment:</th>
            ...
            <tr>
                ...
                <td><fmt:formatDate value="${request.timeRequested}"
                                    pattern="HH:mm EEE, dd-MM-yyyy"/></td>
            </tr>
            <tr>
            ...
            <c:if test="${isAccepted}">
                ...
                <tr>
                    <th>Time Accepted</th>
                    <td><fmt:formatDate value="${request.timeBegin}"
                                        pattern="HH:mm EEE, dd-MM-yyyy"/></td>
                </tr>
                <tr>
                    <th>Repair Diary</th>
                    <td>${request.repairDiary}</td>
                </tr>
        ...
        <strong>As an admin you can deny this request by stating reason below</strong>
        <form action="MainController" method="post">
            <textarea name="denyReason" style="width: 60%; height: 20%; text-align: left">${param.denyReason}</textarea>
            <br>
            <button type="submit" name="action" value="DenyRequest"
                    style="width: 25%; height: 0.75cm; background-color: red">
                Deny this request
            </button>
        ...
        <span style="color:red;">${requestScope.DENY_ERROR}</span>
        <br>
        <hr>
        <c:if test="${not empty param.fromContainer}">
            <a href="admin-mng-request.jsp">Back to requests view</a>
        </c:if>
        <c:if test="${empty param.fromContainer}">
