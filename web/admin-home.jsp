    ...
    <div id="header">
        ...
        <div id="menubar">
            <ul id="menu">
                ...
                <li class="selected"><a href="admin-home.jsp">Home</a></li>
            ...
            <c:if test="${not empty notificationList}">
                ...
                <table width="100%">
                    <tr>
                        <th>Remove</th>
                        <td colspan="2">
                            <button form="mainForm" name="action" type="submit" value="DeleteNotification" style="width: 100%; height: 1cm">
                                Selected
                            </button>
                        </td>
                        <td colspan="2">
                            <button form="mainForm" name="action" type="submit" value="DeleteAllNotification" style="width: 100%; height: 1cm">
                                All
                            </button>
                        </td>
                    </tr>
