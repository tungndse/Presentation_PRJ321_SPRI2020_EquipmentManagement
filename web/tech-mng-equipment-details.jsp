...
<html>
<head>
    <title>Equipment Details (tech view)</title>
    <style>
        html {
            height: 100%;
        }
    ...
    <div id="site_content">
        <table>
            <tr>
                            ...
                            <td colspan="4" style="text-align: left">
                                ...
                                <c:if test="${not empty request}">
                                    <c:url var="viewRequestLink" value="MainController">
                                        ...
                                        <c:param name="fromEquipmentDetails" value="fromEquipmentDetails"/>
                ...
                <!-- Image Panel ----------------------------->
                <td style="width: 50%"><!-- $pageContext.request.contextPath -->
                    <img src="<c:url value='${equipment.imagePath}'/>" alt="No image yet" style="width: 100%; height: 80%"/>
                </td>
            </tr>
        </table>
        <hr>
                ...
                <c:forEach var="report" items="${equipment.reportList}" varStatus="counter">
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="${reportDetailsLink}">Read</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
        ...
        <a href="${equipmentMngLink}">Back to equipment view</a>
    </div>
</div>
...
<hr>
<!---- NEED EQUIPMENT ID PARAM PASSED TO ACCEPT REQUEST --------->
