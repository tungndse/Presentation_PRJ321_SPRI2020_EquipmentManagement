...
<div id="main">
    ...
    <div id="site_content">
        ...
        <c:if test="${not empty container}">
                        ...
                        <tr>
                            ...
                            <td>
                                <c:url var="viewRequestLink" value="MainController">
                                    <c:param name="action" value="ViewRequestAsTech"/>
            ...
            <hr>
            <c:if test="${not empty container.ownedRequestList}">
                ...
                <table>
                    ...
                    <c:forEach var="ownedRequest" items="${container.ownedRequestList}" varStatus="counter">
                        <tr>
                            <td>${counter.count}</td>
                            <td>${ownedRequest.equipment.name}</td>
                            <td>${ownedRequest.equipment.type.name}</td>
                            <td>${ownedRequest.requester.username}</td>
                            <td><fmt:formatDate value="${ownedRequest.timeRequested}" pattern="EEE, HH:mm dd-MM-yyyy"/></td>
                            <td>${ownedRequest.dateCountSinceRequest}</td>
                            <td>${ownedRequest.executor.username}</td>
                            <td><fmt:formatDate value="${ownedRequest.timeBegin}" pattern="EEE, HH:mm dd-MM-yyyy"/></td>
                            <td>${ownedRequest.dateCountSinceBegin}</td>
                            <td>
                                <c:url var="viewRequestLink" value="MainController">
                                    <c:param name="action" value="ViewRequestAsTech"/>
                                    <c:param name="fromContainer" value="fromContainer"/>
                                    <c:param name="requestId" value="${ownedRequest.id}"/>
                                </c:url>
                                <a href="${viewRequestLink}">More</a>
                            </td>
                        </tr>
            ...
            <c:if test="${empty container.ownedRequestList}">
                You have not accepted any request yet
            </c:if>
        </c:if>
